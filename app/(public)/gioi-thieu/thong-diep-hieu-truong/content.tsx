    ...
    >
      ...
      >
        ...
        <div className="hero-content relative max-w-4xl mx-auto space-y-8 flex flex-col items-center px-4 z-10">
          ...
          <div className="hero-description text-lg md:text-xl text-slate-500 leading-relaxed mx-auto font-medium text-center">
            <p className="whitespace-nowrap">
              Trường Đại học Công nghệ Kỹ thuật TP. Hồ Chí Minh (HCM-UTE)
            </p>
            <p className="whitespace-nowrap">
              Nơi ươm mầm tài năng, khơi dậy đam mê và đồng hành cùng sự phát
              triển bền vững.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full mb-32 mt-24">
        ...
        <div className={`section-0 py-12 md:py-24 space-y-12 relative`}>
          ...
          <div className="section-text-0 w-full text-center space-y-6">
            ...
            {/* Applied BLUR Class */}
            <p className="section-text-blur-0 text-lg md:text-xl text-slate-600 leading-relaxed text-justify w-full">
                ...
                <div className="hidden md:grid grid-cols-2 gap-24 min-h-[50vh] items-center">
                  ...
                  >
                    <div className="relative w-full aspect-[4/3] group perspective-1000">
                      {/* Offset border effect - uniform stroke width */}
                      <div
                        className={cn(
                          "absolute inset-0 pointer-events-none translate-x-4 translate-y-4 transition-transform duration-300 ease-out -z-10 hidden md:block",
                          index % 2 === 1
                      ...
                      >
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(to bottom right, #fca5a5, rgba(59,130,246,0.5), #60a5fa)",
