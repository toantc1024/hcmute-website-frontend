...
export function PostForm({
  ...
  const handleSubmitForReview = async () => {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : "Đã xảy ra lỗi khi gửi duyệt";
      toast.error(message);
    } finally {
  ...
  return (
    ...
    >
          ...
          <div>
            ...
            {isEditMode && post && (
              <div className="flex items-center gap-2 mt-1">
                <Badge variant="outline">{getPostStatusLabel(post.status)}</Badge>
              </div>
            )}
            {!isEditMode && (
              <p className="text-muted-foreground">
                Tạo bài viết mới trong chế độ nháp
              </p>
            )}
          </div>
        </div>
        ...
        <motion.div variants={itemVariants} className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              {(coverImage?.publicUrl || (!coverImageCleared && post?.coverImageUrl)) ? (
              ...
              >
                ...
                {(coverImage || (!coverImageCleared && post?.coverImageUrl)) ? "Thay đổi ảnh" : "Chọn ảnh"}
              </Button>
          ...
          {!isEditMode && (
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>• Bài viết sẽ được lưu ở trạng thái <strong>Nháp</strong></p>
                <p>• Sau khi lưu, bạn có thể chỉnh sửa thêm hoặc gửi để duyệt</p>
      ...
      <ImageUploadModal
        ...
        selectedImageId={coverImage?.id || (!coverImageCleared ? post?.coverImageId : undefined)}
        selectedImageUrl={coverImage?.publicUrl || (!coverImageCleared ? post?.coverImageUrl : undefined)}
